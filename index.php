...
function uninstall_users()
{
	...
	mf_uninstall_plugin(array(
		'options' => array('setting_users_show_own_media', 'setting_users_no_spaces', 'setting_users_register_name', 'setting_users_roles_hidden', 'setting_users_roles_names', 'setting_add_profile_fields', 'setting_remove_profile_fields', 'setting_admin_color', $wpdb->prefix.'user_roles_orig'),
